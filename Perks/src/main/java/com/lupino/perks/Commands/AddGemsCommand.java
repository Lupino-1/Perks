...
public class AddGemsCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        try {
            ...
            String message = messageManager.getMessage("YourGemsWereAddedMessage", Map.of("gems",String.valueOf(gems)));
            if (message!=null) {

                targetPlayer.sendMessage(message);
            }
            String message2 = messageManager.getMessage("AddGemsMessage", Map.of("gems",String.valueOf(gems),"playername",playerName));
            if (message2!=null) {
