    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (args.length == 0) {
            ...
            if (sender instanceof Player) {
                ...
                String message = messageManager.getMessage("GemsMeMessage",Map.of("gems",String.valueOf(gems)));
                if (message!=null) {
            ...
            String message = messageManager.getMessage("GemsOtherPlayerMessage",Map.of("gems",String.valueOf(gems),"playername",playerName));
            if (message!=null) {
